...
try:
    ...
    driver.find_element(By.XPATH, "//textarea[@id='order_comments']").send_keys("Special Billet")

    # Enter Date of Birth
    driver.find_element(By.XPATH, "//input[@id='dob']").click()
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select month']")).select_by_visible_text("Feb")
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select year']")).select_by_visible_text("2000")

    # Select Date
    for date in driver.find_elements(By.XPATH, "//table[@class='ui-datepicker-calendar']/tbody/tr/td/a"):
        if date.text == "18":
            date.click()
            break
    ...
    WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//li[contains(text(), \"I'm the only traveler\")]"))
    ).click()
    ...
    # Enter Destination
    driver.find_element(By.XPATH, "//span[@class='woocommerce-input-wrapper']/input[@id='fromcity']").send_keys("TOKYO")
    ...
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select month']")).select_by_visible_text("Sep")
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select year']")).select_by_visible_text("2024")
    ...
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select month']")).select_by_visible_text("Oct")
    Select(driver.find_element(By.XPATH, "//select[@aria-label='Select year']")).select_by_visible_text("2024")
    ...
    WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//li[contains(text(), 'Visa extension')]"))
    ).click()
    time.sleep(2)

    # Enter Contact Information
    driver.find_element(By.XPATH, "(//input[@id='deliverymethod_3'])[1]").click()
    driver.find_element(By.XPATH, "//input[@id='billname']").send_keys("Kato PM  PATRICK")
    driver.find_element(By.XPATH, "(//input[@id='billing_phone'])[1]").send_keys("09070002222")
    driver.find_element(By.XPATH, "(//input[@id='billing_email'])[1]").send_keys("kato@roboco-op.org")
    time.sleep(2)
    ...
    driver.find_element(By.XPATH, "//input[@id='billing_address_1']").send_keys("City-KU Pays 29-8 MASON")
    driver.find_element(By.XPATH, "//input[@id='billing_address_2']").send_keys("Bldg 304")
